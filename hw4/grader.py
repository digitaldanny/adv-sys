...
INPUT ARGUMENTS:
grade - checks if the program generated text file contains the same tuples
        as the expected output.
gen -   generates a new input text file.

EXPECTED FILES:
input.txt - real input example
output.txt - real output example
test_output.txt - output file generated by the combiner program.
'''
...
if __name__ == '__main__':
    ...
    if cmd == 'gen':
        ...
        print("ERROR (grader.py): argument ({}) is not valid.".format(cmd))